...
```{r procedure, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap="Visual representation of the Head-turn Preference Procedure used (see Procedure section).", out.width = "100%"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.cap="Looking time to familiar and unfamiliar words at test, overall and split by testing language. Boxplots represent the median, 25th and 75th percentiles. Contours represent the probability distribution.", out.width="100%"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, fig.height=5, fig.width=5, fig.cap="Looking time by trial type, and difference score by participant. Diamonds represent the difference score (Novel-Familiar). Grey shaded areas represent the mean and standard error of the mean for each trial type", out.width="100%"}
